    ...
    /* USER CODE END WHILE */
	  // Receive temperature data from Slave 1
	        if (HAL_UART_Receive(&huart1, (uint8_t *)uart1_rx_buffer, sizeof(uart1_rx_buffer), 1000) == HAL_OK)
	        {
	            ...
	            tCelsius = atof((char*)uart1_rx_buffer);
	        }
	        ...
	        if (HAL_UART_Receive(&huart2, (uint8_t *)uart2_rx_buffer, sizeof(uart2_rx_buffer), 1000) == HAL_OK)
	        {
	            ...
	            Distance = atof((char*)uart2_rx_buffer);
	        }

	        // Clear the display
	        SSD1306_Fill(SSD1306_COLOR_BLACK);

	        // Check and display messages on OLED
	        if (Distance > 10)
	        {
	          SSD1306_GotoXY(0, 0);
	          SSD1306_Puts("High Distance", &Font_11x18, SSD1306_COLOR_WHITE);
	        }

	        if (tCelsius > 30)
	        {
	          SSD1306_GotoXY(0, 20);
	          SSD1306_Puts("High Temp", &Font_11x18, SSD1306_COLOR_WHITE);
	        }
